...
\begin{enumerate}
    ...
    \item \textbf{Cons}: \textbf{[TODO: Hungarian algorithm details]}
\end{enumerate}
...
\end{tabular}
\end{small}
\caption{Detailed breakdown for Ultra Grid ($100 \times 75$) with 60,000 tiles. The consistent preprocessing times confirm the overhead of feature extraction.}
\end{table}
