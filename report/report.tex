...
\begin{itemize}
    \item \textbf{System}: Apple MacBook Air (M3 Chip with Unified Memory).
...
\hline
\textbf{Splits} & \textbf{Preproc (ms)} & \textbf{Match (ms)} & \textbf{Render (ms)} & \textbf{Total (ms)} \\ \hline
1  & 222.96 & 86103.96 & 1.60 & 86334.78 \\ \hline
2  & 97.00  & 20820.00 & 0.45 & 20920.28 \\ \hline
4  & 76.82  & 5041.18  & 0.20 & 5118.91  \\ \hline
8  & 89.76  & 1504.84  & 0.14 & 1571.71  \\ \hline
16 & 114.16 & 595.40   & 0.12 & 689.20   \\ \hline
32 & 243.02 & 233.71   & 0.06 & 407.46   \\ \hline
64 & 167.13 & 113.73   & 0.05 & 234.16   \\ \hline
\end{tabular}
\end{small}
\caption{Hungarian Algorithm sweep results (1024 cells, 60k tiles). The matching time dropped from 86s to 113ms by increasing splits to 64.}
